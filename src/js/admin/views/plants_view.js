...
const PlantsView = (() => {
    ...
    function render() {
        return `
      ${AdminUtils.renderTopBar('Master - Plants')}
      <div class="admin-card">
        <div class="admin-form-grid">
          <label for="plantCodeInput" class="admin-form-label">Plant Code</label>
          <input id="plantCodeInput" type="text" class="admin-input" placeholder="Enter code...">
          <label for="plantNameInput" class="admin-form-label">Plant Name</label>
          <input id="plantNameInput" type="text" class="admin-input" placeholder="Enter name...">
        </div>
        <div class="admin-btn-row mt-4">
