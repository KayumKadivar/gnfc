...
const UserInfoView = (() => {
    ...
    function render() {
        return `
      ${AdminUtils.renderTopBar('User Information')}
      <div class="admin-card">
        <div class="admin-form-grid">
          <label for="userInfoEc" class="admin-form-label">EC Number</label>
          <input id="userInfoEc" type="text" class="admin-input" placeholder="Enter EC Number...">
          <label for="userInfoName" class="admin-form-label">User Name</label>
          <input id="userInfoName" type="text" class="admin-input" placeholder="Enter name...">
          <label for="userInfoPassword" class="admin-form-label">Password</label>
          <input id="userInfoPassword" type="text" class="admin-input" placeholder="Enter password...">
          <label for="userInfoGroup" class="admin-form-label">Group</label>
